(cognito) PS C:\Users\P90022569\Downloads\LE> python cleaning_excel.py
...
Cache file  : C:\Users\P90022569\Downloads\BOOK3_OUTPUT_lookup_cache.json
...
Step 3 done: 29 explicitly lower-phase row(s) removed.
Step 4 done: 16 duplicate (TA-I, trial_id) row(s) removed.
  Rejoined non-CT rows. Total rows: 49
...
Step 5 done: BQ columns joined.
  Total rows        : 49
  Matched in BQ     : 19
  Not matched in BQ : 30
  Missing primary_region           : 30
  Missing size                     : 31
  Missing drug_arm_size_n          : 31
  Missing dosage                   : 30
...
Step 6 — Missing field summary (before fallback):
  Total rows : 49
  Missing primary_region           : 30 row(s)
  Missing size                     : 31 row(s)
  Missing drug_arm_size_n          : 31 row(s)
  Missing dosage                   : 30 row(s)

  32 row(s) across 19 unique trial ID(s) need fallback.
...
primary_region=Middle East, size=60, drug_arm_size_n=60
  ...
  Verification after CT.gov fill:
    Missing primary_region           : 12 row(s)
    Missing size                     : 8 row(s)
    Missing drug_arm_size_n          : 7 row(s)
    Missing dosage                   : 30 row(s)
...
Step 6 — Missing field summary (after fallback):
  Total rows : 49
  Still missing primary_region      : 12 row(s)
  Still missing size                : 8 row(s)
  Still missing drug_arm_size_n     : 7 row(s)
  Still missing dosage              : 30 row(s)
  Unresolved trial IDs (still have missing fields):
    NCT04595292 — still missing: ['dosage']
    NCT04262973 — still missing: ['dosage']
    NCT05531656 — still missing: ['dosage']
    ...
    NCT04509674 — still missing: ['dosage']
    NCT06109311 — still missing: ['dosage']
...
Step 7 done: 8 row(s) had empty size — set to 0 (rows retained). Remaining rows: 49

Step 8 done: 24 row(s) removed by region-priority filter. Remaining rows: 25

Step 9 done: 19 row(s) removed by max-size filter. Remaining rows: 6
...
Done. Final output: C:\Users\P90022569\Downloads\BOOK3_OUTPUT_processed.xlsx
(cognito) PS C:\Users\P90022569\Downloads\LE> 
